...
public class Group2 implements Group {
    ...
    public actionSet callEmbAsp(PlayerAi player) throws Exception {
        ...
        myHandler.addFactAsObject(new myUnit2(myUnit, myBoard.heightAt(myUnit.coord())));
    ...
    private Point makeMove() throws Exception {
        ...
        moveProgram.addFilesPath(Settings.PATH_ENCOD_GROUP2+ "/move.asp");
...
//        myHandler.setEncoding(myPlayer.getEncodings().get(1)); linux
        ...
        buildProgram.addFilesPath(Settings.PATH_ENCOD_GROUP2+ "/build.asp");
...
//--UTILITY-------------------------------------------------------------------------------------------------------------
    ...
    public boolean equals(Object o) {
        ...
        return myBoard.equals(group2.myBoard) && myPlayer.equals(group2.myPlayer) && myHandler.equals(group2.myHandler) && myUnit.equals(group2.myUnit);
    }
