...
public class myUnit3 {
    ...
    public myUnit3(int x, int y, int height, int unitCode, int playerCode) {

        init(x, y, height, unitCode, playerCode);
    }
    public myUnit3(Point coord, int height , int unitCode, int playerCode ) {

        init(coord.x, coord.y, height, unitCode, playerCode);
    }

    public myUnit3(Unit unit, int height) {
